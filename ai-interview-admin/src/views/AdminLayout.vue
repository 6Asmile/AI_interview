...
const items = computed(() => [
  ...
  { path: '/operations/events', label: '事件与队列', icon: Files, permission: 'platform_events.view' },
  { path: '/reliability', label: '可靠性中心', icon: Connection, permission: 'reliability.manage' },
