...
export interface InterviewSessionItem { id: string; user: UserInfo; job_position: string; status: string; question_count: number; questions: InterviewQuestionItem[]; started_at: string; current_stage?: string; memory_summary?: AgentMemorySummary; covered_topics?: string[]; pending_topics?: string[]; recording_enabled?: boolean; video_upload_task?: string; session_plan?: Record<string, any>; template_snapshot?: Record<string, any>; coverage_summary?: Record<string, any>; }
export interface StartInterviewData { job_position: string; resume_id?: number; jd_text?: string; question_count?: number; recording_enabled?: boolean; difficulty?: 'easy' | 'medium' | 'hard'; template_id?: number | null; }
