...
ASR_CHUNK_MILLISECONDS = int(os.getenv('ASR_CHUNK_MILLISECONDS', '250'))
ASR_PARTIAL_INTERVAL_SECONDS = float(os.getenv('ASR_PARTIAL_INTERVAL_SECONDS', '0.25'))
ASR_PARTIAL_MIN_BYTES = int(os.getenv('ASR_PARTIAL_MIN_BYTES', '4000'))
...
TTS_STREAM_CHUNK_BYTES = int(os.getenv('TTS_STREAM_CHUNK_BYTES', '4096'))
